...
mod tests {
    ...
    fn modifiers() {
        ...
        modifiers.add_modifier(
            ModifierSource::Item(ItemId::new("nat20_core", "item.belt_of_strength")),
            4,
        );
        modifiers.add_modifier(
            ModifierSource::Effect(EffectId::new("nat20_core", "nat20_core::effect.bless")),
            1,
        );
